...
\begin{document}
  ...
  The authors propose a model in which the effects of learning from co-workers can be distinguished from the
  effect of learning from one's own experience. Here, the authors propose that 
  ...
  \begin{figure}[ht]
        \centering
        \includegraphics[width=12cm]{dest_2.pdf}
        \caption{Destre, p.30}
        \label{dest_2}
  \end{figure}

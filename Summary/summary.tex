...
\label{sec:Meeting 5}
  ...
  are the selection bias and the bias of unobservables.
  \begin{itemize}
  ...
  \label{sub:leigh}
  The authors try to find the return on education using three natural experiments.
  \begin{enumerate}
    \item Month of birth\\
    ...
    \item Changes in compulsory schooling laws\\
